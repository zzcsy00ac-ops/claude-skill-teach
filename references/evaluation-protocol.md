...
## Harness
`scripts/run-eval.py` (v3 — parameterized tutor/judge model, auto-runs Layers 1-3, JSON + Markdown report).
**Status:** Script created (2026-08-10). Ready for first run with session corpus.
